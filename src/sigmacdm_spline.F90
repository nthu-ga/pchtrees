...
contains
  ...
  subroutine make_spline
    ...
    call delete_file(trim(power_spec_lock_file), deleted, ierr)
    if (.not.deleted) write (0,*) 'make_spline(): WARNING - failed to remove lock file'
